...
os.chdir('/media/tohn/SSD/Nor_ABnor_Network_25/content/efficientnet_keras_transfer_learning/')
...
root_logdir = '/media/tohn/SSD/Nor_ABnor_Network_25/my_logs'
def get_run_logdir():
    import time
...
#สร้าง folder TensorBoard
root_logdir = '/media/tohn/SSD/Nor_ABnor_Network_25/my_logs_2'
def get_run_logdir():
    import time
    run_id = time.strftime("run_%Y_%m_%d_%H_%M_%S")
    return os.path.join(root_logdir,run_id)
